...
function doFakeShit() {
    if (fakeCounter === 1) addIngredients(fakeIngredientMilk, servingamount.value);
    if (fakeCounter === 2) addIngredients(fakeIngredientMars, servingamount.value);
    if (fakeCounter === 3) addIngredients(fakeIngredientBeef, servingamount.value);
